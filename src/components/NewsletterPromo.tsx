...
/**
 * NewsletterPromo Component - Migrated to Tailwind CSS
 */

// Car and Driver Logo SVG Component
function CarAndDriverLogo() {
  return (
    <svg viewBox="0 0 1364 262" xmlns="http://www.w3.org/2000/svg" className="h-6 w-auto">
...
export function NewsletterPromo({ 
  ...
  return (
    <div
      className={cn(
        "flex flex-col items-end bg-neutral-900 py-24 px-12 gap-2 w-full overflow-hidden relative",
        className
      )}
    >
      {/* Background Watermark Image */}
      <div
        className="absolute inset-0 opacity-15 pointer-events-none bg-cover bg-center bg-no-repeat"
        style={{
      ...
      <div className="flex flex-col gap-3 w-full relative z-10">
        ...
        <div className="flex items-center justify-center w-full">
          <span className="font-sans text-xl font-normal tracking-tight leading-tight text-neutral-100 w-full">
            {eyebrow}
          </span>
        </div>
        ...
        <div className="flex items-center w-full">
          <span className="font-sans text-[42px] font-extrabold tracking-wide leading-tight text-neutral-100">
            {title}
          </span>
        </div>
        ...
        <div className="flex items-center w-full mt-6">
          <button className="inline-flex items-center justify-center px-4 py-2 bg-brand-blue border-none rounded-sm cursor-pointer font-sans text-xs font-semibold tracking-wide leading-none text-neutral-100 uppercase hover:opacity-90 transition-opacity">
            JOIN NOW
          </button>
        </div>
      </div>
      ...
      <div className="absolute bottom-6 right-6 flex items-center text-neutral-100">
        <CarAndDriverLogo />
      </div>
    </div>
  );
