...
function MediaThumbnail({ showPlayIcon = true }: { showPlayIcon?: boolean }) {
  return (
    <div
      style={{
...
function HorizontalStoryCard({ title, timestamp, showPlayIcon = true }: HorizontalStoryCardProps) {
  return (
    <div
      style={{
        display: 'flex',
    ...
    >
      {/* Media Thumbnail */}
      <MediaThumbnail showPlayIcon={showPlayIcon} />
...
export function LeftSidebarColumn({ 
  title = '{title}',
  stories = [
    { id: 1, title: "Why Did Valerie Bertinelli Leave 'Kids", timestamp: '{timestamp}' },
    { id: 2, title: "Why Did Valerie Bertinelli Leave 'Kids", timestamp: '{timestamp}' },
    ...
    { id: 5, title: "Why Did Valerie Bertinelli Leave 'Kids", timestamp: '{timestamp}' },
    { id: 6, title: "Why Did Valerie Bertinelli Leave 'Kids", timestamp: '{timestamp}' },
  ]
