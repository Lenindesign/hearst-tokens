...
/**
 * Footer Component - Migrated to Tailwind CSS
 */
  ...
  if (type === 'tiktok') {
    return (
      <div className="w-6 h-6 flex items-center justify-center cursor-pointer">
        <svg width={20} height={20} viewBox="0 0 50 58" fill="currentColor">
          <path 
            fillRule="evenodd" 
            clipRule="evenodd"
...
// Car and Driver Logo for Footer
function CarAndDriverLogoFooter() {
  return (
    <svg viewBox="0 0 1364 262" xmlns="http://www.w3.org/2000/svg" className="h-7 w-auto">
...
function NetworkLogo() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 349 82" className="h-10 w-auto">
      <path 
        fill="currentColor"
...
export function Footer({
  ...
  return (
    <div className={cn("w-full bg-neutral-900", className)}>
      <footer className="flex flex-col gap-12 w-full max-w-[1200px] py-8 px-6 mx-auto text-neutral-100">
        ...
        <div className="flex items-start gap-8 flex-wrap">
          {menuColumns.map((column, index) => (
            <div key={index} className="flex flex-col gap-3 min-w-[200px] flex-1">
              {/* Section Title */}
              ...
              {column.links.map((link, linkIndex) => (
                <span
                  key={linkIndex}
                  className="font-sans text-sm font-normal cursor-pointer hover:underline"
                >
                  {link}
                </span>
              ))}
        ...
        <div className="flex flex-col gap-4 border-t border-neutral-100 pt-6">
          ...
          <span className="font-sans text-sm font-normal max-w-[600px]">
            {legalText.affiliate}
          </span>
          ...
          <div className="flex items-center gap-2 px-3 py-2 border border-neutral-100 cursor-pointer w-fit">
            {/* Privacy Icon */}
