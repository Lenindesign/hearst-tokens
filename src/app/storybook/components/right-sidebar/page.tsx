      ...
      <section style={{ marginBottom: spacing['3xl'] }}>
        ...
        >
          <div style={{ maxWidth: 300 }}>
            <RightSidebarColumn
              cards={[
                { id: 1, description: 'Best SUVs of 2024: Our Top Picks', author: 'Auto Editor' },
                { id: 2, description: 'Electric vs Gas: Cost Comparison', author: 'Tech Writer' },
                { id: 3, description: 'How to Save on Car Insurance', author: 'Finance Expert' },
              ]}
            />
          </div>
        </div>
